...
class resnet_v1_101_fcis_dcn_v1(Symbol):
    ...
    def get_resnet_v1_conv4_dcn_v1(self, data):
        ...
        res4b22_branch2b = mx.symbol.Convolution(name='res4b22_branch2b', data=res4b22_branch2a_relu, num_filter=256,
                                                 pad=(1, 1), kernel=(3, 3), stride=(1, 1), no_bias=True)
        '''
        res4b22_branch2b_offset_weight = mx.symbol.Variable('res4b22_branch2b_offset_weight', lr_mult=1.0)
        res4b22_branch2b_offset_bias = mx.symbol.Variable('res4b22_branch2b_offset_bias', lr_mult=2.0)
    ...
    def get_resnet_v1_conv5_dcn_v2(self, conv_feat):        
        ####res5####
        res5a_branch1 = mx.symbol.Convolution(name='res5a_branch1', data=conv_feat, num_filter=2048, pad=(0, 0),
                                              kernel=(1, 1), stride=(1, 1), no_bias=True)
        bn5a_branch1 = mx.symbol.BatchNorm(name='bn5a_branch1', data=res5a_branch1, use_global_stats=True, fix_gamma=False, eps=self.eps)
        ...
        #construct ModulatedDeformableConvolution
        ...
        #res5a_branch2b_offset contain both position offset and scale offset(mask) 108 = 36*3,36 = (3*2)(3*2), 3 is kernel and dilate is 2
        res5a_branch2b_offset = mx.symbol.Convolution(name='res5a_branch2b_offset', data = res5a_branch2a_relu,
                                                      num_filter=108, pad=(2, 2), kernel=(3, 3), stride=(1, 1), dilate=(2, 2), cudnn_off=True,
                                                      weight=res5a_branch2b_offset_weight, bias=res5a_branch2b_offset_bias)
        res5a_branch2b_offset_t = mx.sym.slice_axis(res5a_branch2b_offset,axis = 1,begin=0,end=72)
        res5a_branch2b_offset_mask = mx.sym.slice_axis(res5a_branch2b_offset,axis = 1,begin=72,end=None)
        res5a_branch2b_offset_mask = 2 * mx.sym.Activation(res5a_branch2b_offset_mask, act_type='sigmoid')
        res5a_branch2b = mx.contrib.symbol.ModulatedDeformableConvolution(name='res5a_branch2b', data=res5a_branch2a_relu, 
                                                                offset=res5a_branch2b_offset_t, mask = res5a_branch2b_offset_mask,
        ...
        res5b_branch2b_offset_t = mx.sym.slice_axis(res5b_branch2b_offset, axis=1, begin=0, end=72)
        res5b_branch2b_offset_mask = mx.sym.slice_axis(res5b_branch2b_offset,axis = 1, begin = 72,end=None)
        res5b_branch2b_offset_mask = 2*mx.sym.Activation(res5b_branch2b_offset_mask,act_type='sigmoid')
        res5b_branch2b = mx.contrib.symbol.DeformableConvolution(name='res5b_branch2b', data=res5b_branch2a_relu,
                                                                offset=res5b_branch2b_offset_t, mask = res5b_branch2b_offset_mask,
                                                                num_filter=512, pad=(2, 2), kernel=(3, 3), num_deformable_group=4,
                                                                stride=(1, 1), dilate=(2, 2), no_bias=True)
        bn5b_branch2b = mx.symbol.BatchNorm(name='bn5b_branch2b', data=res5b_branch2b, use_global_stats=True,
                                            fix_gamma=False, eps=self.eps)
        ...
        res5c_branch2b_offset_t = mx.sym.slice_axis(res5c_branch2b_offset,axis=1,begin=0,end=72)
        res5c_branch2b_offset_mask = mx.sym.slice_axis(res5c_branch2b_offset,axis=1,begin = 72,end = None)
        res5c_branch2b_offset_mask = 2*mx.sym.Activation(res5c_branch2b_offset,act_type='sigmoid')
        res5c_branch2b = mx.contrib.symbol.DeformableConvolution(name='res5c_branch2b', data=res5c_branch2a_relu, 
                                                                offset=res5c_branch2b_offset_t,mask = res5c_branch2b_offset_mask,
                                                                num_filter=512, pad=(2, 2), kernel=(3, 3), num_deformable_group=4,
                                                                stride=(1, 1), dilate=(2, 2), no_bias=True)
        bn5c_branch2b = mx.symbol.BatchNorm(name='bn5c_branch2b', data=res5c_branch2b, use_global_stats=True,
                                            fix_gamma=False, eps=self.eps)
    ...
    def init_weight(self, cfg, arg_params, aux_params):
        ...
        arg_params['fcis_cls_seg_offset_weight'] = mx.nd.zeros(shape = self.arg_shape_dict['fcis_cls_seg_offset_weight'])
        arg_params['fcis_cls_seg_offset_bias'] = mx.nd.zeros(shape = self.arg_shape_dict['fcis_cls_seg_offset_bias'])

        arg_params['fcis_bbox_offset_weight'] = mx.nd.zeros(shape = self.arg_shape_dict['fcis_bbox_offset_weight'])
        arg_params['fcis_bbox_offset_bias'] = mx.nd.zeros(shape = self.arg_shape_dict['fcis_bbox_offset_bias'])
